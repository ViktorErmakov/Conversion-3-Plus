...
Процедура Расш1_СтраницыПриСменеСтраницыПосле(Элемент, ТекущаяСтраница)
	...
	Если ТекущаяСтраница.Имя = "Страница_ПриОбработке" И ИспользоватьНесколькоПравилКонвертации Тогда
	...
	ИначеЕсли ТекущаяСтраница.Имя = "Страница_ПриОбработке" Тогда
		ИспользованиеПКО.Добавить(Объект.ПравилоКонвертацииОбъекта);
	КонецЕсли;
...
&НаКлиенте
Процедура ОбновитьОписаниеМетаданных(ИспользованиеПКО = Неопределено)
