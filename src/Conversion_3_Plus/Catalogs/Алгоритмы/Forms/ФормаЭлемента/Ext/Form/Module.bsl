...
&НаКлиенте
Процедура Расш1_ЗаменитьВхожденияПосле(Команда)
	КонсольКода.editor.trigger("", "editor.action.changeAll");//КонсольКода.editor._actions.editor.action.addSelectionToNextFindMatch
КонецПроцедуры
