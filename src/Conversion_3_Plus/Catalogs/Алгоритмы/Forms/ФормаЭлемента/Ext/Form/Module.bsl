...
Процедура СменитьТемуАлгоритмHTML(Команда)
	...
	Если СветлаяТема Тогда
		Элементы["СменитьТемуАлгоритмHTML"].Заголовок = "Темная";
		Элементы["СменитьТемуАлгоритмHTML"].ЦветФона = WebЦвета.Черный;
		Элементы["СменитьТемуАлгоритмHTML"].ЦветТекста = WebЦвета.Белый;
	Иначе
		Элементы["СменитьТемуАлгоритмHTML"].Заголовок = "Светлая";
		Элементы["СменитьТемуАлгоритмHTML"].ЦветФона = Новый Цвет();
		Элементы["СменитьТемуАлгоритмHTML"].ЦветТекста = Новый Цвет();
	КонецЕсли;
