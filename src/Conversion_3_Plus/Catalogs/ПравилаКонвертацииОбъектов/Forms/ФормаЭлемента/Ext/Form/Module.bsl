...
Процедура Расш1_ПриОткрытииПосле(Отказ)
	...
	Если ЭтоКонвертацияXDTO Тогда
		...
		Если ОбластьПрименения = 1 Тогда
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПередПолучениемДанных.Имя);
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПриПолученииДанных.Имя);
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПослеЗагрузкиВсехДанныхТекст.Имя);
		ИначеЕсли ОбластьПрименения = 0 Тогда
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПриОтправкеДанных.Имя);
		Иначе
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПередПолучениемДанных.Имя);
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПриПолученииДанных.Имя);
			НазначитьРеквизитуКонсолиАдрес(Элементы.АлгоритмПослеЗагрузкиВсехДанныхТекст.Имя);
...
&НаКлиенте
Процедура НазначитьРеквизитуКонсолиАдрес(ИмяЭлемента)
	
	Если ПустаяСтрока(ЭтотОбъект[ИмяЭлемента + "HTML"]) Тогда
		ЭтотОбъект[ИмяЭлемента + "HTML"] = АдресКонсолиКода;
	КонецЕсли;
...
Функция ПолучитьОписаниеПараметровJSON(Знач Конвертация, Знач ОбъектКонфигурации, Знач Направление, Знач ИмяСтраницы)
	...
	ОписаниеПользовательскихОбъектовJSON = Расш1_КоллекцияМетаданных.ПолучитьОписаниеМетаданныхJSON(ОписаниеПользовательскихОбъектов);
