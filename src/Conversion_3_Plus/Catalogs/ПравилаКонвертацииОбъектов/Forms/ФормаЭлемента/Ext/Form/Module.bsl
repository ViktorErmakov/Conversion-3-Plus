...
Процедура ОбновитьОписаниеМетаданных()
	...
	ЭтотОбъект["ОписаниеМетаданныхJSON"] = 
		ПолучитьОписаниеМетаданныхJSON(ЭтотОбъект["Конвертация"], Объект.ОбъектКонфигурации, Направление);
	ОбновитьОписаниеМетаданныхВоВсехКонсоляхОбработчиков();
	
КонецПроцедуры

&НаСервереБезКонтекста
Функция ПолучитьОписаниеМетаданныхJSON(Знач Конвертация, Знач ОбъектКонфигурации, Знач Направление)
