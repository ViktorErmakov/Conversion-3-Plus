...
Процедура СоздатьКонсоль(ЭлементАлгоритма, ЭлементРодитель, Форма) Экспорт
	...
	Реквизит = СоздатьРеквизит(ИмяРеквизита);
	...
	СоздатьКоманднуюПанель(ИмяРеквизита, Форма, ЭлементАлгоритма);
...
&НаСервере
Функция СоздатьРеквизит(ИмяРеквизита)
...
&НаСервере
Процедура СоздатьКоманднуюПанель(ЭлементАлгоритма, Форма, ЭлементПеред)
	
	ЭлементыФормы = Форма.Элементы;
	КоманднаяПанель = 
		ЭлементыФормы.Вставить(ЭлементАлгоритма + "ПанельКоманд", Тип("ГруппаФормы"), , ЭлементПеред);
